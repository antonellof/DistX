...
vectX is designed as a simple, fast, in-memory vector database with Redis-style simplicity and Qdrant API compatibility. The architecture follows these principles:
