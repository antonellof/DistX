...
This guide will help you get vectX up and running quickly.
...
vectX uses LMDB for fast persistence. Install it based on your platform:
...
The release binary will be at `target/release/vectx`.
...
- Check [Architecture](ARCHITECTURE.md) to understand how vectX works
